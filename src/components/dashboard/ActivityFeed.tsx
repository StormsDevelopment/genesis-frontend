...
const mockActivities: Activity[] = [
  {
    ...
    type: "validation",
    sector: "Ambulatório",
    description: "Ponto de Auditoria",
    points: 10,
  ...
  },
  {
    ...
    type: "vital",
    sector: "UTI Adulto",
    description: "Ponto de Calibração",
    points: 100,
  ...
  },
  {
    id: "4",
    type: "notification",
    sector: "Farmácia e Suprimentos",
    description: "Ponto de Wish List",
    points: -100,
    timestamp: "Há 1 hora",
  },
  {
  ...
  },
  {
    ...
    type: "audit",
    sector: "Transporte",
    description: "Notificação de Ausência",
    points: 50,
  ...
  },
  {
    ...
    type: "audit",
    sector: "Laboratório",
    description: "Notificação de Agravamento",
    points: 50,
    timestamp: "Há 3 horas",
    user: "Carlos Souza",
  },
